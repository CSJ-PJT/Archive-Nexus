...
- 물류 이벤트(`LOGISTICS_DISPATCHED`, `URGENT_DELIVERY_REQUESTED`, `SHIPMENT_HOLD_RELEASED`, `MATERIAL_TRANSFER_REQUESTED`, `QUALITY_REPLACEMENT_SHIPMENT`)는 `Archive-Logitics`를 경유해 처리하도록 설계했습니다.
