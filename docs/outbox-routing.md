...
cold-chain handling, and emergency delivery surcharges belong to Archive-Logitics. Ledger should
...
- `logitics`: publishes only events routed to Archive-Logitics.
...
If Archive-Logitics or Archive-Ledger is unavailable:
