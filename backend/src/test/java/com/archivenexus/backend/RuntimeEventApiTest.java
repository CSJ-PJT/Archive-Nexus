...
class RuntimeEventApiTest {
    ...
    void operationsSummaryIncludesLiveFlowContract() throws Exception {
        mvc.perform(get("/api/operations/summary"))
                ...
                .andExpect(jsonPath("$.economy.materialCost").value(org.hamcrest.Matchers.greaterThan(0)))
                ...
                .andExpect(jsonPath("$.economy.status").value("SYNTHETIC_PERSISTED_OUTBOX_24H"))
                .andExpect(jsonPath("$.economy.available").value(true))
                .andExpect(jsonPath("$.economy.financialEventCount").value(org.hamcrest.Matchers.greaterThan(0)))
                .andExpect(jsonPath("$.economy.querySucceeded").value(true))
                .andExpect(jsonPath("$.economy.calculationScope", startsWith("PERSISTED_OUTBOX_EVENTS_LAST_24_HOURS")))
                ...
                .andExpect(jsonPath("$.economy.sourceLatestEventAt").exists())
                .andExpect(jsonPath("$.production.productionRequested").value(0))
                .andExpect(jsonPath("$.production.productionCompleted").value(0))
                .andExpect(jsonPath("$.production.productionBacklog").value(0))
